...
export default function RootLayout({
  ...
  return (
    <html
      lang="en"
      className="h-full antialiased bg-[#04050a]"
      style={{ backgroundColor: '#04050a', color: '#ffffff' }}
    >
      <head>
        <meta
          httpEquiv="Content-Security-Policy"
          content="default-src 'self' 'unsafe-inline' 'unsafe-eval' http://localhost:* http://127.0.0.1:* ws://localhost:* ws://127.0.0.1:* https://fonts.googleapis.com https://fonts.gstatic.com data: blob:;"
        />
