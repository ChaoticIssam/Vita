  ...
  return (
    <div className="flex w-full flex-col items-center justify-center" style={{ width: '100%', display: 'flex', flexDirection: 'column', alignItems: 'center' }}>
      ...
      <div className="relative w-full max-w-[412px]" style={{ width: '100%', maxWidth: '412px', position: 'relative' }}>
        ...
        {/* Glass Card Frame */}
        <div 
          className="relative z-0 min-h-[340px] w-full rounded-[12px] border border-white/12 border-t-white/30 bg-[#16182e]/25 p-7 opacity-[0.96] shadow-[0_25px_60px_rgba(0,0,0,0.6),0_0_40px_rgba(34,211,238,0.06)] backdrop-blur-[20px] backdrop-saturate-[190%] transition-all duration-300 hover:border-white/20"
          ...
          <form action="javascript:void(0);" onSubmit={handleSubmit} className="flex h-full flex-col justify-between space-y-6" style={{ height: '100%', display: 'flex', flexDirection: 'column', justifyContent: 'space-between' }}>
            ...
            <div className="space-y-3.5 pb-1 mt-6">
              ...
              <div className="text-center text-[11px] text-white/45 font-light" style={{ textAlign: 'center', fontSize: '11px', color: 'rgba(255,255,255,0.5)', marginTop: '12px' }}>
                ...
                <Link href="/login" className="font-semibold text-white transition hover:text-white/80 underline-offset-2 hover:underline ml-0.5" style={{ color: '#ffffff', fontWeight: 600 }}>
                  Sign in
                </Link>
              </div>
            </div>
